        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-card/95 backdrop-blur-sm text-card-foreground p-4 rounded-xl shadow-xl border border-accent/20">
                <div className="flex items-center space-x-3">
                  <div className="bg-accent/10 rounded-full p-2">
                    <MessageCircle className="w-5 h-5 text-accent" />
                  </div>
                  <div>
                    <p className="font-semibold text-sm">IA Especializada</p>
                    <p className="text-xs text-muted-foreground">24/7 Disponível</p>
                  </div>
                </div>
              </div>

              <div className="absolute -top-4 -right-4 bg-card/95 backdrop-blur-sm text-card-foreground p-4 rounded-xl shadow-xl border border-accent/20">
                <div className="flex items-center space-x-3">
                  <div className="bg-accent/10 rounded-full p-2">
                    <MapPin className="w-5 h-5 text-accent" />
                  </div>
                  <div>
                    <p className="font-semibold text-sm">Zona Sul</p>
